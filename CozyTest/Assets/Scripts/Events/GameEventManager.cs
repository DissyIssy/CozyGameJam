...
//This is the static version (no singleton) of an EventBus I've used for many years that you can use in your own Unity projects.

namespace GameEvents.Manager
{
	...
	------------------------------------------------------------------------------------------------------------------------------
        ...
        SomethingHappenedEvent e = new SomethingHappenedEvent();
		e.timeToEndShift = 50f;
